...
const Signup = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!name || !email || !password) return toast.warning("Please fill all fields");
    ...
    return (
        <div className="min-h-screen flex w-full">
            ...
            <div className="hidden lg:flex w-1/2 bg-gradient-to-bl from-[#1a1a23] to-[#0f0f13] relative overflow-hidden items-center justify-center p-12 order-2">
                ...
                <div className="absolute bottom-[-20%] left-[-20%] w-[60%] h-[60%] bg-purple-600/30 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: "1s" }}></div>

                <div className="relative z-10 text-center glass p-10 rounded-3xl border border-white/5 backdrop-blur-md">
                    <img src={logo} alt="Logo" className="w-56 h-28 mx-auto mb-4 object-contain" />
                    ...
                    <p className="text-xl text-gray-300 leading-relaxed max-w-md">
                        Create an account to save collections, download high-res assets, and more.
                    </p>
                </div>
            </div>
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                        ...
                        <div className="flex items-center text-sm">
                            <input id="terms" type="checkbox" className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-700 rounded bg-[#1a1a23]" />
