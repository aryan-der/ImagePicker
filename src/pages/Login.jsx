    ...
    return (
        <div className="min-h-screen flex w-full">
            ...
            <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-[#0f0f13] to-[#1a1a23] relative overflow-hidden items-center justify-center p-12">
                ...
                <div className="absolute bottom-[-20%] right-[-20%] w-[60%] h-[60%] bg-indigo-600/30 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: "1s" }}></div>
                ...
                <div className="relative z-10 text-center glass p-10 rounded-3xl border border-white/5 backdrop-blur-md">
                    ...
                    <p className="text-xl text-gray-300 leading-relaxed max-w-md">
                        Discover millions of breathtaking photos, videos, and GIFs. <br /> Your creative journey starts here.
                    </p>
                </div>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center">
                                <input id="remember-me" type="checkbox" className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-700 rounded bg-[#1a1a23]" />
